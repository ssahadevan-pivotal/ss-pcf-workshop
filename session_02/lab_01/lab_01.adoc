...
+
----
$ cd $COURSE_HOME/session_02/attendees
----
...
====
----
Using manifest file /Users/pivotal/cbusch/pivotal-perficient-stl-workshop/session_02/attendees/manifest.yml <1>
...
Uploading app files from: /Users/pivotal/cbusch/pivotal-perficient-stl-workshop/session_02/attendees/target/attendees-0.0.1.jar
