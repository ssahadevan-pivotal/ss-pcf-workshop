...
In your favorite IDE, open the directory `session_03/lab_04/initial`, or in a command prompt, change directories to `session_03/lab_04/initial`. This is an empty HelloWorldApplication java app.
...
== Delete application.properties
   Verify that application.properties file is removed
...
- name: hello-world
  ...
  memory: 1G
  instances: 1
  path: ./build/libs/gs-actuator-service-initial.jar
----
